...
import com.github.megbailey.gsheets.GSpreadsheetManager;
...
public class GAuthentication {
    ...
    public void authenticateWithServiceAccount() throws  IOException, GeneralSecurityException {
        ...
        InputStream credentialsStream = GSpreadsheetManager.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
